...
namespace Scenaristar
{
    public partial class TemplateForm : Form
    {
        ...
        public ScenarioSMG2 GetScenarioTemplate(List<string> Zones, ref List<ScenarioSMG2> Scenarios)
        {
